  ...
  const steps = [
    {
      ...
      description:
        "We begin with a webinar that's not just motivational — it's transformational.",
      details: [
      ...
      highlight:
        "You'll hear directly from AI professionals at Microsoft, Amazon, or Google about what it actually means to work in high-stakes AI roles.",
    ...
    },
    {
      ...
      description:
        "After the webinar, you'll attempt our AI Readiness Assessment — designed by industry experts — covering:",
      details: [
      ...
      highlight:
        "Top scorers are directly mapped to our hiring team. Others are contacted by our counseling team — because we believe intent > skill.",
      outcome:
        "Even if you're not yet job-ready, your drive matters — and we commit to help you bridge the gap.",
    },
    {
      number: "03",
      title: "Personalized Upskilling → AI Deployment",
      subtitle:
        "If selected or referred for upskilling, here's your fast-tracked path to high-impact roles:",
      icon: Rocket,
      ...
      highlight:
        "This shows recruiters what you can build, not just what you can say.",
      outcome:
        "Get referred for freelance, full-time, or consulting roles — or even pitch your own product if you want to go solo.",
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl text-foreground/80 max-w-4xl mx-auto leading-relaxed">
            We don't just train — we assess, elevate, and deploy AI talent into
            high-impact roles.
          </p>
        </motion.div>
                ...
                <CardContent className="p-8 sm:p-12">
                  <div className="grid lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-2 flex flex-col items-center lg:items-start">
                      <div
                        className={`size-20 rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                      >
                        <step.icon className="size-10 text-white" />
                      </div>
                      <Badge
                        variant="outline"
                        className="bg-gradient-to-r from-[#0BC5EA]/20 to-[#6B46C1]/20 border-[#0BC5EA]/30 text-[#0BC5EA] font-bold text-lg px-4 py-2"
                      >
                        Step {step.number}
                      </Badge>
                    </div>
          ...
          <div className="relative z-10">
            <div className="text-center mb-12">
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">
                Start your AI Journey to Flagship Program Page
              </h3>
            </div>
            ...
            <div className="text-center">
              <p className="text-xl text-foreground/90 font-semibold mb-8 max-w-4xl mx-auto">
                Our program blends flexibility with rigorous, practical training
                to ensure you gain job-ready AI skills.
              </p>
              <a href="/courses">
                <Button
                  size="lg"
