...
const ModalOption = ({
  ...
  <div className="group relative">
    <div
      className={`absolute inset-0 ${colorScheme.bg} rounded-xl blur-sm group-hover:blur-none transition-all duration-300`}
    ></div>
    <Card
      className={`relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 ${colorScheme.border} hover:border-opacity-75 transition-all duration-300 group-hover:scale-[1.02] group-hover:shadow-xl`}
    >
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge
            className={`${colorScheme.textColor.replace("text-", "bg-")}/20 ${
          ...
          <CardContent className="p-6 md:p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="w-full sm:w-auto border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white text-sm sm:text-base px-6 sm:px-8 py-3"
              ...
              <Button
                size="lg"
                className="w-full sm:w-auto bg-yellow-600 hover:bg-yellow-700 text-sm sm:text-base px-6 sm:px-8 py-3"
            ...
            <p className="text-xs sm:text-sm text-gray-400 mt-4 sm:mt-6 px-2">
              ...
              <span className="text-purple-400">support@ailinc.com</span>
            </p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="space-y-6 pt-4">
            ...
            <div className="text-center pt-4 border-t border-slate-700/50">
              <p className="text-sm text-slate-400 mb-2">
                💡 <strong>Pro Tip:</strong> Take the assessment for the best
                program match
              </p>
              <p className="text-xs text-slate-500">
                Both options help you make an informed decision about your AI
                career journey
              </p>
            </div>
          </div>
