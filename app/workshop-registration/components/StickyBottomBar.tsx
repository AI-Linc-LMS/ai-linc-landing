    ...
    >
      <div className="container mx-auto px-4 py-1 md:py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 md:gap-4 text-center sm:text-left">
            <div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 md:gap-3">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#0BC5EA] to-[#6B46C1] hover:from-[#0BC5EA]/90 hover:to-[#6B46C1]/90 text-white font-bold py-1 md:py-3 px-6 rounded-lg text-base transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl min-w-[200px] group"
              size="lg"
            >
